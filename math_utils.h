...
// problem_rps.c
unsigned long long mult_peasant_mod(unsigned long long a, unsigned long long b,
                                    unsigned mod);
unsigned long long calc_tetration_mod(unsigned long long a,
                                      unsigned long long b, unsigned mod);

// problem_mf.c
struct Matrix mult_matrix_mod(const struct Matrix m1, const struct Matrix m2,
                              unsigned mod);
